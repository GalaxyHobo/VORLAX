...
CLVB      WRITE (7,*) 'XAF'
      DO JJ=1, NAP
       READ (99, *)  XAF (JJ)
      END DO
CLVB      WRITE (7, 80) (XAF (JJ), JJ = 1, NAP)
      RLE1 = 0.0
      RLE2 = 0.0
      IF (ILE .NE. 0)  THEN
       ...
       WRITE (7, 80) RLE1
      ENDIF
CLVB      IF (PDL(I).GT.360.) THEN
CLVB       WRITE(7,*) 'ZC1 - CAMBER OF BODY AXIS'
CLVB      ELSE
CLVB       WRITE(7,*) 'ZC1 - CAMBER OF WING ROOT'
CLVB      ENDIF
      DO JJ=1,NAP
       READ (99,*) ZC1 (JJ)
      END DO
CLVB      WRITE (7, 80) (ZC1 (JJ) , JJ = 1, NAP)
      IF (ILE .NE. 0) THEN
      ...
      ENDIF
CLVB      IF (PDL(I) .GT. 360.) THEN
CLVB       WRITE(7,*) 'ZC2 - AREA RATIO OF FUSIFORM BODY'
CLVB      ELSE
CLVB       WRITE(7,*) 'ZC2 - CAMBER OF WING TIP'
CLVB      ENDIF
      DO JJ=1,NAP
       READ (99, *) ZC2 (JJ)
      END DO
