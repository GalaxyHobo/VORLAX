...
C...                                                                     
     ...
     * TNT (1000), XTE (1000), IPAN (1000)                                  
      ...
      COMMON /SET11 /MACH (8), ALPHA (8), ALFA, VINF, NMACH, NALPHA      
...
C 7/3/2002 - TT
	...
	CHARACTER*255 X
      ...
      OPEN(UNIT=99,NAME='VORLAX.SCR')

c   TEST
      OPEN(UNIT=5,NAME='C:\vorlax\wing3.inp')

 10 	 READ(5,100,END=20) X
       IF (X(1:1).NE.'*') WRITE(99,100) X(1:80)
	GO TO 10
 20	CLOSE(UNIT=99)
 100	FORMAT(A80,'\')
	RETURN
